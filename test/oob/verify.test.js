...
describe('oob/verify', function() {
  ...
  it('should be annotated', function() {
    ...
    expect(factory['@implements'][1]).to.equal('http://schemas.authnomicon.org/js/login/mfa/opt/authy/oob/verify');
  ...
  describe('verify', function() {
    ...
    describe('a valid token received via SMS', function() {
      var ok;
      ...
      before(function(done) {
        ...
        verify(authenticator, undefined, opts, function(_err, _ok) {
      ...
      it('should verify token', function() {
        ...
        expect(call.args[1]).to.equal('1234567');
      });
